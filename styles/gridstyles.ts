export const EQUIPMENT_SET_STYLES: Record<string, string> = {
  ...
  gloves: 'col-start-2 col-span-2 row-start-5 row-span-2',
  boots: 'col-start-6 col-span-2 row-start-5 row-span-2',
  ring: 'col-start-3 col-span-1 row-start-4 row-span-1',
  ring2: 'col-start-6 col-span-1 row-start-4 row-span-1',
...
export const EQUIPMENT_FLASK_STYLES: Record<string, string> = {
  ...
  flask3: 'col-start-6 col-span-1 row-start-1 row-span-2',
